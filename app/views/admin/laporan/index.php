            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800 page-heading"><?= $data['title'] ?></h1>
                        <a href="#" class="btn btn-sm btn-primary shadow-sm button-heading"><i
                    ...
                    <div class="row">
                        <div class="container-fluid">
                            <!-- Page Heading -->
                            <h1 class="h3 mb-2 text-gray-800 text-center">Laporan SPP</h1>
                            <p class="mb-4 text-center">SMKN 1 Denpasar</p>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php $i = 1; ?>
                                                    <?php foreach($data['laporan'] as $res): ?>
                                                        <tr>
                                                            <td><?= $i ?></td>
