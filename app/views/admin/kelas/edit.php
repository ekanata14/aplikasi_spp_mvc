                    ...
                    <div class="row">
                        <div class="container-fluid">
                            ...
                            <div class="col-6 card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="<?= B ?>/kelas/editKelasAct" method="POST">
                                        ...
                                        <div class="form-group my-3">
                                            ...
                                            <select name="kompetensi_keahlian" id="kompetensiKehalian" class="form-control">
                                                <?php for($i = 0; $i < count($data['komka']); $i++): ?>
                                                    <?php if($data['komka'][$i] == $data['kelas']['kompetensi_keahlian']):?>
                                                        <option value="<?= $data['komka'][$i] ?>" selected><?= $data['komka'][$i] ?></option> 
                                                    <?php else: ?>
